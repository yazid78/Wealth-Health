      ...
      parseDate: function (e, t) {
        ...
        for (n = e.replace(c.separators, "\0").split("\0"), r = 0; r < n.length; r++)
          switch (((o = n[r]), (i = parseInt(o)), a[r])) {
            ...
            case "h":
              if (
                ((f = n[(d = -1 < a.indexOf("a") ? a.indexOf("a") : -1 < a.indexOf("A") ? a.indexOf("A") : -1)]),
                -1 < d)
              )
          ...
          N.id && _.attr("id", N.id),
            ...
            F.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", function (e) {
              ...
              for (
                ...
                o += t[0].offsetHeight;
              return (
                n.xdsoftScroller(N, o / (n.children()[0].offsetHeight - n[0].clientHeight)), e.stopPropagation(), !1
              );
            });
          var l = function (e) {
            ...
            return (
              N.startDate
                ...
                : N.defaultDate &&
                  ...
                  N.defaultTime &&
                    ((e = W.strtotime(N.defaultTime)), t.setHours(e.getHours()), t.setMinutes(e.getMinutes()))),
          ...
          F.find(".xdsoft_select")
              ...
              (r.now = function (e) {
                ...
                (r.nextMonth = function () {
                  ...
                  return (
                    ...
                    N.onChangeMonth &&
                      L.isFunction(N.onChangeMonth) &&
                      N.onChangeMonth.call(_, W.currentTime, _.data("")),
                    e !== r.currentTime.getFullYear() &&
                      L.isFunction(N.onChangeYear) &&
                      N.onChangeYear.call(_, W.currentTime, _.data("input")),
                    _.trigger("xchange.xdsoft"),
                ...
                (t = setTimeout(function () {
                  ...
                  for (
                    ...
                    ((!1 !== h && h < f) ||
                      ...
                      (0 !== f.getDay() &&
                        6 !== f.getDay() &&
                        -1 === N.weekends.indexOf(E.formatDate(f, N.formatDate))) ||
                  ...
                  for (P.html(b), H = "", c = parseInt(N.yearStart, 10); c <= parseInt(N.yearEnd, 10); c += 1)
                    H +=
                      ...
                      "</div>";
                  for (
                    A.children().eq(0).html(H), c = parseInt(N.monthStart, 10), H = "";
            ...
            O.on("mousewheel.xdsoft", function (e) {
              return (
                ...
                (!N.datepicker && N.timepicker
                  ? (0 <=
                      (a = P.find(".xdsoft_current").length ? P.find(".xdsoft_current").eq(0).index() : 0) + e.deltaY &&
            ...
            (r = function () {
              ...
              "rtl" === s.parent().css("direction") && (n -= _.outerWidth() - s.outerWidth()),
                N.fixed
                  ...
                  : ((i = !1),
                    h(t, function (e) {
                      return (
                        null !== e &&
                        ("fixed" === N.contentWindow.getComputedStyle(e).getPropertyValue("position")
                          ? !(i = !0)
                          : void 0)
                      );
                    }),
                ...
                h(o, function (e) {
                  if (
                    "relative" === N.contentWindow.getComputedStyle(e).getPropertyValue("position") &&
                    d >= e.offsetWidth
                  )
                ...
                O.is(":disabled") ||
                  ...
                  (N.openOnFocus &&
                    ...
                    (d = setTimeout(function () {
                      O.is(":disabled") ||
                        ((s = !0), W.setCurrentTime(f(), !0), N.mask && c(N), _.trigger("open.xdsoft"));
                    }, 100))));
              })
